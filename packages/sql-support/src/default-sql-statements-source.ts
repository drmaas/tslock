...
export class DefaultSqlStatementsSource extends SqlStatementsSource {
  ...
  constructor(config: SqlConfiguration) {
    ...
    this.#insert = `INSERT INTO ${t}(${c.name}, ${c.lockUntil}, ${c.lockedAt}, ${c.lockedBy}) VALUES(:name, :lockUntil, :now, :lockedBy)`;
